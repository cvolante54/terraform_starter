...
//git env vars
env.git_url = 'https://github.com/cvolante54/terraform_starter.git'
env.git_branch = 'master'
env.credentials_id = '1'

//slack env vars
env.slack_url = 'https://hooks.slack.com/services/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'
env.notification_channel = 'caerus'

//jenkins env vars
env.jenkins_server_url = 'http://127.0.0.1:8080'
